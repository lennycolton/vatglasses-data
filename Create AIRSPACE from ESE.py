...
with open('VATGlasses Data/SECTOR.txt',"r",encoding='utf-8') as f:
    # File like:
...
def removesequentialduplicates(coors):
    ...
    return new_coors
#Creates a nested list of the sectors' coordinates
...
with open('VATGlasses Data/airspace.json', 'w') as outfile:
